...
public class PlayerMovement : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        float horizontalMultiplier = ((Input.GetAxis("Horizontal") < 0 && player.position.x > -85) || (Input.GetAxis("Horizontal") > 0 && player.position.x < 80)) ? Input.GetAxis("Horizontal") : 0;
